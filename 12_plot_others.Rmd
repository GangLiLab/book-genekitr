...
plotVenn(sm_gene_list,
  ...
  alpha_degree = 1,
  remove_grid = TRUE,
  color = ggsci::pal_lancet()(3) # three colors for three elements in sm_gene_list
)
```
...
```{r upsetVenn, fig.height=7, fig.width=6, fig.cap="(ref:upsetVennCap)", fig.scap="(ref:upsetVennScap)", dpi=300}
