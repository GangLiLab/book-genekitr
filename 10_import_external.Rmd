...
(ref:impCPDOScap) Chord plot of clusterProfiler result.

(ref:impCPDOCap) **Chord plot of clusterProfiler result.** 

```{r impCPDO, fig.height=10, fig.width=10, fig.cap="(ref:impCPDOCap)", fig.scap="(ref:impCPDOScap)",dpi=300}
plotEnrich(do_easy, 
           plot_type = "network", 
           layout = "circle", 
           scale_ratio = 1,
