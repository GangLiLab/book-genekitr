...
If `genekitr` helps your research, please cite:

Liu, Y., & Li, G. (2023). Empowering biologists to decode omics data: the Genekitr R package and web server. *BMC Bioinformatics*, 24(1), 214.
