...
After analyzing group enrichment analysis for [GO](#go-group-enrichment) or [KEGG](#kegg-group-enrichment), we could use `dotplot` to show the result:
...
(ref:dotplotGroupCap) **Dot plot of group enrichment analysis.** 
