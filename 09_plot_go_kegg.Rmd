...
```{r barplot, fig.width=12, fig.height=10, fig.cap="(ref:barplotCap)", fig.scap="(ref:barplotScap)"}
library(patchwork)
...
pp <- p1 + p2 + p3 + p4 + plot_annotation(tag_levels = 'A')
pp
```
...
```{r bubbleplot, fig.height=5, fig.width=5, fig.cap="(ref:bubbleplotCap)", fig.scap="(ref:bubbleplotScap)"}
library(patchwork)
...
(ref:dotplotScap) Dot plot of enrichment analysis.

(ref:dotplotCap) **Dot plot of enrichment analysis.** default (A), modify bubble size (B).

```{r dotplot, fig.height=5, fig.width=5, fig.cap="(ref:dotplotCap)", fig.scap="(ref:dotplotScap)"}
library(patchwork)
p1 <- plotEnrich(ego,plot_type = "dot")
p2 <- plotEnrich(ego,plot_type = "dot", scale_ratio = 1, stats_metric = "pvalue")
p1 + p2 + plot_annotation(tag_levels = 'A')
```
...
```{r wegoplot, fig.height=5, fig.width=5, fig.cap="(ref:wegoplotCap)", fig.scap="(ref:wegoplotScap)"}
...
```{r lolliplot, fig.height=5, fig.width=5, fig.cap="(ref:lolliplotCap)", fig.scap="(ref:lolliplotScap)"}
...
```{r heatmap, fig.height=3, fig.width=5, fig.cap="(ref:heatmapCap)", fig.scap="(ref:heatmapScap)"}
library(patchwork)
...
```{r chord, fig.height=5, fig.width=8, fig.cap="(ref:chordCap)", fig.scap="(ref:chordScap)"}
library(patchwork)
show_gene = c('BRCA2','CDK1','JUN','MCM8','TIPIN')
...
```{r network, fig.height=5, fig.width=5, fig.cap="(ref:networkCap)", fig.scap="(ref:networkScap)"}
library(patchwork)
library(igraph)
library(ggraph)
...
```{r map, fig.height=5, fig.width=5, fig.cap="(ref:mapCap)", fig.scap="(ref:mapScap)"}
library(igraph)
library(ggraph)
...
```{r goheat, fig.height=5, fig.width=5, fig.cap="(ref:goheatCap)", fig.scap="(ref:goheatScap)"}
...
```{r gotangram, fig.height=5, fig.width=5, fig.cap="(ref:gotangramCap)", fig.scap="(ref:gotangramScap)"}
...
```{r wordcloud, fig.height=5, fig.width=5, fig.cap="(ref:wordcloudCap)", fig.scap="(ref:wordcloudScap)"}
...
```{r upset, fig.height=5, fig.width=5, fig.cap="(ref:upsetCap)", fig.scap="(ref:upsetScap)"}
...
(ref:themeCap) **Plot theme.** default theme (A), modify text size (B),  modify grid and border size (C) and modify all text (D).

```{r theme, fig.height=5, fig.width=5, fig.cap="(ref:themeCap)", fig.scap="(ref:themeScap)"}
library(patchwork)
p1 <- plotEnrich(ego,plot_type = "dot")
p2 <- plotEnrich(ego,plot_type = "dot", main_text_size = 10, legend_text_size  = 10)
